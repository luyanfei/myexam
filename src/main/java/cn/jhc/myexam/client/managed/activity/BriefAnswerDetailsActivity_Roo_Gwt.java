...
import cn.jhc.myexam.client.managed.ui.BriefAnswerDetailsView.Delegate;
...
public abstract class BriefAnswerDetailsActivity_Roo_Gwt extends AbstractActivity implements Delegate, IsScaffoldMobileActivity {

    protected ApplicationRequestFactory requests;

    protected EntityProxyId<BriefAnswerProxy> proxyId;

    protected PlaceController placeController;

    protected AcceptsOneWidget display;

    protected BriefAnswerDetailsView view;

    public void deleteClicked() {
        if (!view.confirm("Really delete this entry? You cannot undo this change.")) {
            return;
        }
        requests.briefAnswerRequest().deleteBriefAnswer(view.getValue()).fire(new Receiver<Void>() {
