...
public class BriefAnswerEditActivityWrapper extends BriefAnswerEditActivityWrapper_Roo_Gwt {

    private final EntityProxyId<BriefAnswerProxy> proxyId;

    public BriefAnswerEditActivityWrapper(ApplicationRequestFactory requests, View<?> view, Activity activity, EntityProxyId<BriefAnswerProxy> proxyId) {
    ...
    public Place getBackButtonPlace() {
        return (proxyId == null) ? new ProxyListPlace(BriefAnswerProxy.class) : new ProxyPlace(proxyId, ProxyPlace.Operation.DETAILS);
    }
    ...
    public interface View<V extends cn.jhc.myexam.client.managed.ui.BriefAnswerEditView<V>> extends View_Roo_Gwt<V> {
    }
}
