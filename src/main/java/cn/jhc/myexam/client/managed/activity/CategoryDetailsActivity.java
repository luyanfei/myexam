...
public class CategoryDetailsActivity extends CategoryDetailsActivity_Roo_Gwt {

    public CategoryDetailsActivity(EntityProxyId<CategoryProxy> proxyId, ApplicationRequestFactory requests, PlaceController placeController, CategoryDetailsView view) {
    ...
    public Place getBackButtonPlace() {
        return new ProxyListPlace(CategoryProxy.class);
    }
    ...
    public void start(AcceptsOneWidget displayIn, EventBus eventBus) {
        ...
        Receiver<EntityProxy> callback = new Receiver<EntityProxy>() {
            ...
            public void onSuccess(EntityProxy proxy) {
                ...
                view.setValue((CategoryProxy) proxy);
