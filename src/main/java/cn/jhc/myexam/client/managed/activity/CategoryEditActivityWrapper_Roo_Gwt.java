...
public abstract class CategoryEditActivityWrapper_Roo_Gwt implements Activity, IsScaffoldMobileActivity {
    ...
    public void start(AcceptsOneWidget display, EventBus eventBus) {
        view.setParentPickerValues(Collections.<CategoryProxy>emptyList());
        requests.categoryRequest().findCategoryEntries(0, 50).with(cn.jhc.myexam.client.managed.ui.renderer.CategoryProxyRenderer.instance().getPaths()).fire(new Receiver<List<CategoryProxy>>() {
            ...
            public void onSuccess(List<CategoryProxy> response) {
                ...
                view.setParentPickerValues(values);
            }
        });
        view.setChildrenPickerValues(Collections.<CategoryProxy>emptyList());
        requests.categoryRequest().findCategoryEntries(0, 50).with(cn.jhc.myexam.client.managed.ui.renderer.CategoryProxyRenderer.instance().getPaths()).fire(new Receiver<List<CategoryProxy>>() {
    ...
    public interface View_Roo_Gwt<V extends cn.jhc.myexam.client.managed.ui.CategoryEditView<V>> extends CategoryEditView<V> {
