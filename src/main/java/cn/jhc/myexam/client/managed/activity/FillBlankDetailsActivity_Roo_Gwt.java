...
import cn.jhc.myexam.client.managed.ui.FillBlankDetailsView.Delegate;
...
public abstract class FillBlankDetailsActivity_Roo_Gwt extends AbstractActivity implements Delegate, IsScaffoldMobileActivity {

    protected ApplicationRequestFactory requests;

    protected EntityProxyId<FillBlankProxy> proxyId;

    protected PlaceController placeController;

    protected AcceptsOneWidget display;

    protected FillBlankDetailsView view;

    public void deleteClicked() {
        if (!view.confirm("Really delete this entry? You cannot undo this change.")) {
            return;
        }
        requests.fillBlankRequest().deleteFillBlank(view.getValue()).fire(new Receiver<Void>() {
