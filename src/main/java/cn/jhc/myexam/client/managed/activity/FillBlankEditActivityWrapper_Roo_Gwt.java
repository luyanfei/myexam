...
public abstract class FillBlankEditActivityWrapper_Roo_Gwt implements Activity, IsScaffoldMobileActivity {
    ...
    public interface View_Roo_Gwt<V extends cn.jhc.myexam.client.managed.ui.FillBlankEditView<V>> extends FillBlankEditView<V> {
