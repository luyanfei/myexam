...
public class GlossaryEditActivityWrapper extends GlossaryEditActivityWrapper_Roo_Gwt {

    private final EntityProxyId<GlossaryProxy> proxyId;

    public GlossaryEditActivityWrapper(ApplicationRequestFactory requests, View<?> view, Activity activity, EntityProxyId<GlossaryProxy> proxyId) {
    ...
    public Place getBackButtonPlace() {
        return (proxyId == null) ? new ProxyListPlace(GlossaryProxy.class) : new ProxyPlace(proxyId, ProxyPlace.Operation.DETAILS);
    }
    ...
    public interface View<V extends cn.jhc.myexam.client.managed.ui.GlossaryEditView<V>> extends View_Roo_Gwt<V> {
    }
}
