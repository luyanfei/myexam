...
import cn.jhc.myexam.client.managed.ui.QuizDetailsView.Delegate;
...
public abstract class QuizDetailsActivity_Roo_Gwt extends AbstractActivity implements Delegate, IsScaffoldMobileActivity {

    protected ApplicationRequestFactory requests;

    protected EntityProxyId<QuizProxy> proxyId;

    protected PlaceController placeController;

    protected AcceptsOneWidget display;

    protected QuizDetailsView view;

    public void deleteClicked() {
        if (!view.confirm("Really delete this entry? You cannot undo this change.")) {
            return;
        }
        requests.quizRequest().deleteQuiz(view.getValue()).fire(new Receiver<Void>() {
