...
public abstract class QuizEditActivityWrapper_Roo_Gwt implements Activity, IsScaffoldMobileActivity {
    ...
    public interface View_Roo_Gwt<V extends cn.jhc.myexam.client.managed.ui.QuizEditView<V>> extends QuizEditView<V> {
