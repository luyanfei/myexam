...
public abstract class QuizListActivity_Roo_Gwt extends AbstractProxyListActivity<QuizProxy> implements IsScaffoldMobileActivity {

    protected ApplicationRequestFactory requests;

    public QuizListActivity_Roo_Gwt(PlaceController placeController, ProxyListView<QuizProxy> view, Class<QuizProxy> proxyType) {
        super(placeController, view, proxyType);
    }

    protected void fireCountRequest(Receiver<Long> callback) {
        requests.quizRequest().countAllQuizes().fire(callback);
    }
}
