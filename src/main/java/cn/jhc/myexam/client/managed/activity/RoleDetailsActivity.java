...
public class RoleDetailsActivity extends RoleDetailsActivity_Roo_Gwt {

    public RoleDetailsActivity(EntityProxyId<RoleProxy> proxyId, ApplicationRequestFactory requests, PlaceController placeController, RoleDetailsView view) {
    ...
    public Place getBackButtonPlace() {
        return new ProxyListPlace(RoleProxy.class);
    }
