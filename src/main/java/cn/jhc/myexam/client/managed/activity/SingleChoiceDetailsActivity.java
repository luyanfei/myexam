...
public class SingleChoiceDetailsActivity extends SingleChoiceDetailsActivity_Roo_Gwt {

    public SingleChoiceDetailsActivity(EntityProxyId<SingleChoiceProxy> proxyId, ApplicationRequestFactory requests, PlaceController placeController, SingleChoiceDetailsView view) {
    ...
    public Place getBackButtonPlace() {
        return new ProxyListPlace(SingleChoiceProxy.class);
    }
    ...
    public void start(AcceptsOneWidget displayIn, EventBus eventBus) {
        ...
        Receiver<EntityProxy> callback = new Receiver<EntityProxy>() {
            ...
            public void onSuccess(EntityProxy proxy) {
                ...
                view.setValue((SingleChoiceProxy) proxy);
