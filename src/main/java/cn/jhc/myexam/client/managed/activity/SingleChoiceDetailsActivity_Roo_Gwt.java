...
import cn.jhc.myexam.client.managed.ui.SingleChoiceDetailsView.Delegate;
...
public abstract class SingleChoiceDetailsActivity_Roo_Gwt extends AbstractActivity implements Delegate, IsScaffoldMobileActivity {

    protected ApplicationRequestFactory requests;

    protected EntityProxyId<SingleChoiceProxy> proxyId;

    protected PlaceController placeController;

    protected AcceptsOneWidget display;

    protected SingleChoiceDetailsView view;

    public void deleteClicked() {
        if (!view.confirm("Really delete this entry? You cannot undo this change.")) {
            return;
        }
        requests.singleChoiceRequest().deleteSingleChoice(view.getValue()).fire(new Receiver<Void>() {
