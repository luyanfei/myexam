...
public class TrueOrFalseDetailsActivity extends TrueOrFalseDetailsActivity_Roo_Gwt {

    public TrueOrFalseDetailsActivity(EntityProxyId<TrueOrFalseProxy> proxyId, ApplicationRequestFactory requests, PlaceController placeController, TrueOrFalseDetailsView view) {
    ...
    public Place getBackButtonPlace() {
        return new ProxyListPlace(TrueOrFalseProxy.class);
    }
    ...
    public void start(AcceptsOneWidget displayIn, EventBus eventBus) {
        ...
        Receiver<EntityProxy> callback = new Receiver<EntityProxy>() {
            ...
            public void onSuccess(EntityProxy proxy) {
                ...
                view.setValue((TrueOrFalseProxy) proxy);
