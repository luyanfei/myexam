...
public abstract class TrueOrFalseListActivity_Roo_Gwt extends AbstractProxyListActivity<TrueOrFalseProxy> implements IsScaffoldMobileActivity {

    protected ApplicationRequestFactory requests;

    public TrueOrFalseListActivity_Roo_Gwt(PlaceController placeController, ProxyListView<TrueOrFalseProxy> view, Class<TrueOrFalseProxy> proxyType) {
        super(placeController, view, proxyType);
    }

    protected void fireCountRequest(Receiver<Long> callback) {
        requests.trueOrFalseRequest().countAllTrueOrFalses().fire(callback);
    }
}
