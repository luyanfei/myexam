...
public abstract class BriefAnswerMobileListView_Roo_Gwt extends MobileProxyListView<BriefAnswerProxy> {

    protected Set<String> paths = new HashSet<String>();

    public BriefAnswerMobileListView_Roo_Gwt(String buttonText, SafeHtmlRenderer<BriefAnswerProxy> renderer) {
