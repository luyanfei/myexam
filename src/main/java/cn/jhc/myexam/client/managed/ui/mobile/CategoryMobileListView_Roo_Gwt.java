...
public abstract class CategoryMobileListView_Roo_Gwt extends MobileProxyListView<CategoryProxy> {

    protected Set<String> paths = new HashSet<String>();

    public CategoryMobileListView_Roo_Gwt(String buttonText, SafeHtmlRenderer<CategoryProxy> renderer) {
