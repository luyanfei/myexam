...
public abstract class FillBlankMobileListView_Roo_Gwt extends MobileProxyListView<FillBlankProxy> {

    protected Set<String> paths = new HashSet<String>();

    public FillBlankMobileListView_Roo_Gwt(String buttonText, SafeHtmlRenderer<FillBlankProxy> renderer) {
