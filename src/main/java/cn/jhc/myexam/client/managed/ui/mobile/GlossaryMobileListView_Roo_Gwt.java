...
public abstract class GlossaryMobileListView_Roo_Gwt extends MobileProxyListView<GlossaryProxy> {

    protected Set<String> paths = new HashSet<String>();

    public GlossaryMobileListView_Roo_Gwt(String buttonText, SafeHtmlRenderer<GlossaryProxy> renderer) {
