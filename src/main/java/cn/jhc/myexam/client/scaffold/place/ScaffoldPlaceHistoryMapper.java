package cn.jhc.myexam.client.scaffold.place;
 ...
 * {@link cn.jhc.myexam.client.scaffold.place.Place Place}s your app can navigate to. In
 ...
 * {@link cn.jhc.myexam.client.scaffold.place.ProxyListPlace ProxyListPlace}s (which show
 * all entities of a particular type) and
 * {@link cn.jhc.myexam.client.scaffold.place.ProxyPlace ProxyPlace}s (which give access to
