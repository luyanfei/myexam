...
public class TeacherNavigator extends CustomComponent {
	...
	private static final Logger logger = Logger
			.getLogger(TeacherNavigator.class.getName());
	...
	public static enum NavigateItem {
		import_users("导入考生帐号"), add_user("添加考生"), add_exam("添加考试"), list_exams(
				"查看考试"), import_questions("导入题目"), list_questions("查看题目"), view_result(
				"查看结果"), gen_result("生成结果");
	...
	private void buildButtonsList(HasComponents container) {
		for (Iterator<com.vaadin.ui.Component> iterator = container.iterator(); iterator.hasNext();) {
			com.vaadin.ui.Component component = iterator.next();
			if (component instanceof HasComponents) {
				HasComponents hasComponents = (HasComponents) component;
				buildButtonsList(hasComponents);
				continue;
			}
