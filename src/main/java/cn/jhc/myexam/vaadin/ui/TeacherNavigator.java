...
public class TeacherNavigator extends CustomComponent {
	...
	/**
	 * This method must be called after UI has set navigator.
	 */
	public void buildButtonListener(){
		Navigator navigator = getUI().getNavigator();
		if(navigator == null)
			throw new IllegalStateException("Got null navigator object in TeacherNavigator, "
					+ "check initialization of Navigator object.");
