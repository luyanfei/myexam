...
import cn.jhc.myexam.vaadin.window.AddUserWindow;
import cn.jhc.myexam.vaadin.window.ImportUsersWindow;
...
public class UserManagerView extends CustomComponent implements View{
	...
	public UserManagerView(UserService theUserService) {
		...
		this.addUserWindow = new AddUserWindow(this, userService);
		...
		importUsersButton.addClickListener(new Button.ClickListener() {
			...
			@Override
			public void buttonClick(ClickEvent event) {
				ImportUsersWindow importUsersWindow = new ImportUsersWindow(UserManagerView.this, userService);
	...
	public BeanItemContainer<User> getContainer() {
		return (BeanItemContainer<User>) usersTable.getContainerDataSource();
	}
